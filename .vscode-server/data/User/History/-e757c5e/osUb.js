...
const createPosts = (e) => {
  ...
  const removePost = (posts, e) => {
    e.preventDefault()
    setList(list.filter(p => p.id !==posts.id))
  ...
  return (
    ...
    <form className="form">
      ...
      <div>
       <Select defaultValue="по умолчанию" defaultVal="по дате"></Select>
      <PostList prop={list} removePost={removePost}/>
     <form>
